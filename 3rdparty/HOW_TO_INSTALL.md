# Library Names: fpm, imgui, imgui_club

Those libraries are **NOT included in the repository** by design.
The files must be downloaded manually in the 3rdparty folder following
