...
bool psxemu::init(int wndWidth, int wndHeight, const std::string& biosFileName, const std::string& gameFileName, const std::string& exeFileName)
{
    //Initialize SDL
    ...
    isRunning = true;
    pPsx = std::make_shared<Psx>(biosFileName, gameFileName, exeFileName);
