...
Renderer::Renderer(const uint16_t* pData)
{
    ...
    glVertexAttribPointer(4, 2, GL_FLOAT, GL_FALSE, sizeof(VertexInfo), (GLvoid*)offsetof(VertexInfo, texPageCoords));
    glEnableVertexAttribArray(4);
    glVertexAttribPointer(5, 1, GL_FLOAT, GL_FALSE, sizeof(VertexInfo), (GLvoid*)offsetof(VertexInfo, texColorDepth));
    glEnableVertexAttribArray(5);
    glVertexAttribPointer(6, 1, GL_FLOAT, GL_FALSE, sizeof(VertexInfo), (GLvoid*)offsetof(VertexInfo, textured));
    glEnableVertexAttribArray(6);
    // glVertexAttribPointer(7, 1, GL_FLOAT, GL_FALSE, sizeof(VertexInfo), (const void*)offsetof(VertexInfo, transparent));
    // glEnableVertexAttribArray(7);
    // glVertexAttribPointer(8, 1, GL_FLOAT, GL_FALSE, sizeof(VertexInfo), (const void*)offsetof(VertexInfo, blending));
...
bool Renderer::DrawPolygon(std::vector<VertexInfo>& e)
{
...
{ 
    ...
    glBindTexture(GL_TEXTURE_RECTANGLE, textureId);
    //Draw all Triangles
    glDrawArrays(GL_TRIANGLES, 0, (int)drawData.size());
